-- ============================================================================
-- Mortal Warcraft Overhaul - World Database Tables
-- Part of the mod-mortal AzerothCore module
-- ============================================================================

-- Zone Risk Flags
DROP TABLE IF EXISTS `zones_risk_flags`;
CREATE TABLE `zones_risk_flags` (
    `zone_id` INT UNSIGNED NOT NULL PRIMARY KEY,
    `risk_tier` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '0=Green(safe), 1=Yellow(mid-risk), 2=Red(full-loot)',
    `description` VARCHAR(128) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Default zone mappings
INSERT INTO `zones_risk_flags` (`zone_id`, `risk_tier`, `description`) VALUES
(1,    0, 'Kalimdor - Safe'),
...
-- Workstation Gameobjects
DROP TABLE IF EXISTS `mortal_workstations`;
CREATE TABLE `mortal_workstations` (
    `gameobject_entry` INT UNSIGNED NOT NULL PRIMARY KEY,
    `workstation_type` TINYINT UNSIGNED NOT NULL COMMENT '1=Forge, 2=Anvil, 3=Cooking, 4=Alchemy, 5=Engineering'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `mortal_workstations` (`gameobject_entry`, `workstation_type`) VALUES
(100, 1),
(101, 2),
(102, 3),
(103, 4),
...
DROP TABLE IF EXISTS `mortal_task_board_templates`;
CREATE TABLE `mortal_task_board_templates` (
...
DROP TABLE IF EXISTS `mortal_ecosystem_spawn_weights`;
CREATE TABLE `mortal_ecosystem_spawn_weights` (
...
-- Contract Templates
DROP TABLE IF EXISTS `mortal_contract_templates`;
CREATE TABLE `mortal_contract_templates` (
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
-- Caravan Routes
DROP TABLE IF EXISTS `mortal_caravan_routes`;
CREATE TABLE `mortal_caravan_routes` (
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
INSERT INTO `mortal_caravan_routes` (`id`, `start_zone`, `end_zone`, `duration`, `reward_gold`, `risk_tier`) VALUES
(1, 1, 3, 300, 50, 0),
(2, 3, 1, 300, 50, 1),
(3, 1519, 3, 600, 100, 2);

-- Stronghold Locations
DROP TABLE IF EXISTS `mortal_stronghold_locations`;
CREATE TABLE `mortal_stronghold_locations` (
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `zone_id` INT UNSIGNED NOT NULL,
...
INSERT INTO `mortal_stronghold_locations` (`id`, `zone_id`, `name`, `pos_x`, `pos_y`, `pos_z`, `map_id`) VALUES
(1, 33, 'STV Stronghold', 0, 0, 0, 0),
(2, 1, 'Kalimdor Keep', 0, 0, 0, 1);

-- Titles System
DROP TABLE IF EXISTS `mortal_titles`;
CREATE TABLE `mortal_titles` (
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
INSERT INTO `mortal_titles` (`id`, `title`, `condition_type`, `condition_value`) VALUES
(1, 'the Brave', 0, 100),
...
-- Regional Bank NPCs
DROP TABLE IF EXISTS `mortal_regional_bank_npcs`;
CREATE TABLE `mortal_regional_bank_npcs` (
    `entry` INT UNSIGNED NOT NULL PRIMARY KEY,
    `zone_id` INT UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `mortal_regional_bank_npcs` (`entry`, `zone_id`) VALUES
(2500, 1),
(2501, 3),
(2502, 1519);
