...
-- Feature: Wiki Articles for Mortal Schema
-- Description: Populates mortal_wiki_articles with comprehensive content
-- Based on: docs/specs/49-webportal-wiki-spec.md
-- ==================================================

-- Wiki Articles for mortal_wiki_articles table
INSERT INTO `mortal_wiki_articles` (`article_slug`, `title`, `content`, `category`, `tags`, `is_published`, `is_featured`, `created_at`, `last_edited_at`) VALUES
('welcome', 'Welcome to Mortal Warcraft', '# Welcome to Mortal Warcraft
...
'GAMEPLAY', JSON_ARRAY('getting-started', 'introduction', 'overview'), 1, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
...
'GAMEPLAY', JSON_ARRAY('combat', 'pvp', 'risk-zones', 'crime'), 1, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),

('factions', 'Factions System', '# Factions
...
'GAMEPLAY', JSON_ARRAY('factions', 'pledging', 'reputation'), 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),

('lifeskills', 'Fishing & First Aid', '# Lifeskills: Fishing & First Aid
...
'GAMEPLAY', JSON_ARRAY('fishing', 'first-aid', 'lifeskills'), 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
...
'GAMEPLAY', JSON_ARRAY('runes', 'augments', 'gear', 'enhancements'), 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),

('season-challenges', 'Season Challenges', '# Season Challenges
...
'GAMEPLAY', JSON_ARRAY('seasons', 'challenges', 'progression'), 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),

('build-presets', 'Build Presets', '# Build Presets
...
'GAMEPLAY', JSON_ARRAY('builds', 'presets', 'loadouts'), 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),

('endless-contracts', 'Endless Contracts', '# Endless Contracts
...
'PVE', JSON_ARRAY('endless-contracts', 'defense', 'survival'), 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),

('progression-system', 'Progression System', '# Progression System
...
'GAMEPLAY', JSON_ARRAY('progression', 'leveling', 'skills', 'attributes'), 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP())
...
FROM mortal_wiki_articles
WHERE article_slug IN ('welcome', 'combat-system', 'factions', 'lifeskills', 'runes-augments', 'season-challenges', 'build-presets', 'endless-contracts', 'progression-system');
