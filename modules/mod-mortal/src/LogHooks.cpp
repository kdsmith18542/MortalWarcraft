...
void LogHooks::Load() { LOG_INFO("module", ">> mod-mortal: LogHooks system loaded"); InitializeLogTables(); }
...
{ LOG_INFO("module", "mod-mortal: PvP Kill - {} killed {} in zone {}", killerGuid, victimGuid, zoneId); }
